...
SHORT = COMMIT[:7]
# The folder is `Raissi_disc_time_approach/` at COMMIT; it was renamed to
# `multi_network_chain_discrete_approach/` on 2026-09-16. Moving COMMIT past the
# rename means changing the folder name below as well.
