  ...
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \begin{enumerate}
        ...
        \item \hl{System and data} (5 slides). Why van der Pol first, the shared
    ...
    \begin{column}{0.5\textwidth}
      \begin{enumerate}
        \setcounter{enumi}{4}
        \item \hl{Results on van der Pol} (10 slides). The cliff, causal
        ...
        \item \hl{Results on LHCb} (13 slides). Six experiments with their full
  ...
  \begin{columns}[T]
    \begin{column}{0.46\textwidth}
      ...
      {\small The harvest: dump the simulation truth; turn each tracker hit into
       ...
       $5\mm$; split by particle, because legs from one particle are highly
...
% ---- 42 ------------------------------------------------------------------
\begin{frame}[shrink=25]{Training where no labels exist: the reversed magnet polarity reaches the same floor}
  \vspace{2mm}
  \centering\small
  \begin{tabular}{@{}lrr@{}}
    \toprule
    quantity & magnet up (reversed) & magnet down (original) \\
    \midrule
  ...
  \begin{columns}[T]
    \begin{column}{0.47\textwidth}
      \fbox{\parbox{0.93\textwidth}{\small
        ...
        own twin; and it reaches the same floor on a polarity with no labels.}}
    \end{column}
    \begin{column}{0.47\textwidth}
      \fbox{\parbox{0.93\textwidth}{\small
