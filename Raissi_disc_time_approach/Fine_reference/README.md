# Fine_reference — the sixth-order reference and how far it can be trusted  (Block C, C1)
...
— the same selection `../Magnet_tracks_dataset` builds on — 20 per momentum band
...
[`../Magnet_tracks_dataset/README.md`](../Magnet_tracks_dataset/README.md). All
...
[`../Magnet_tracks_dataset`](../Magnet_tracks_dataset) measures head-on.
...
caller's own state array — `../Magnet_tracks_dataset` runs 12,000 legs with the
...
`../Magnet_tracks_dataset` is built with.
