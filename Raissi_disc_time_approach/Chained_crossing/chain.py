...
single-step full-crossing cell of `../Step_size_and_stage_grid`'s tables and is
...
between the 10 mm dense states of `../Magnet_tracks_dataset`. When N < 50
...
N_CHECKPOINTS = 50
REFERENCE_FLOOR_UM = 5e-5          # ../Fine_reference C1.4, over a crossing
