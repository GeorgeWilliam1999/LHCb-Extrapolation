...
`../Step_size_and_stage_grid/results/table_cells.csv` for the single-step
...
* **single step, full crossing** - the same architecture's own single-step cell
  from `../Step_size_and_stage_grid` C4, at each q. It is what the chain has to
