...
`../C0_Magnet_tracks_dataset/results/magnet_tracks_v3.npz`, solves the q-stage
...
`Y` were built with (`../C0_Magnet_tracks_dataset/README.md`). Passing it rather
...
def write_meta(qs, split, cap, field_which, wall_s):
    meta = {
        ...
        "q_values": list(qs),
        "solver": {
            "module": "C2_Exact_scheme_table/exact_solver.py",
            "generalised_from": "../../Block_0_first_pass/S1_Simple_first_pass/exact_scheme.py solve_leg",
