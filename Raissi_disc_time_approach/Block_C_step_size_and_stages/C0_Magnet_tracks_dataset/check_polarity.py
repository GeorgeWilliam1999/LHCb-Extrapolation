...
What is measured
  ...
  1. The two maps are exact negatives of one another (a cheap re-check of
     `../../Block_A_technique_works/A4_Magnet_up_field`'s A4.1 finding, on random in-map points).
...
def main():
    ...
    out["consequence"] = [
        ...
        "(S2b_One_step_network_v2, A3a_General_leg_network, A3b_Chained_legs, ...) are "
        ...
        "../../Block_A_technique_works/A4_Magnet_up_field is framed as 'a polarity for which no labelled "
