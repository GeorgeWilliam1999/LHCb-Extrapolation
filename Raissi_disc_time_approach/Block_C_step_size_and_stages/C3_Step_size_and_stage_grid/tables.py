...
own table from `../C2_Exact_scheme_table` and the straight line's, and writes
...
SCHEME = os.path.join(HERE, "..", "C2_Exact_scheme_table", "results")
...
# ../C1_Fine_reference C1.4: the worst case over 200 momentum-stratified whole
