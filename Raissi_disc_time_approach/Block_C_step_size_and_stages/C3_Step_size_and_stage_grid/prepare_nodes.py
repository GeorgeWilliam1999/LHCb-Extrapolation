...
`../C0_Magnet_tracks_dataset/results/magnet_tracks_v3.npz` stores each row's start
...
(which `../C0_Magnet_tracks_dataset` produced in a single unsegmented march) and
...
def build(q, n_train, n_eval, source=SOURCE, which=_FIELD_WHICH,
    ...
    meta = {
        "kind": "general", "built_by": "C3_Step_size_and_stage_grid/prepare_nodes.py",
