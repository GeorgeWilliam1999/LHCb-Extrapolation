# C3_Step_size_and_stage_grid — width, depth and stages on the magnet-to-magnet set  (Block C, C3)

**What this is.** One network architecture grid, trained on
[`../C0_Magnet_tracks_dataset`](../C0_Magnet_tracks_dataset)'s magnet-to-magnet set —
...
[`../C1_Fine_reference`](../C1_Fine_reference) — and scored **per step-length
...
open by [`../../Block_A_technique_works/A3a_General_leg_network`](../../Block_A_technique_works/A3a_General_leg_network)'s residual wave: how
...
| [tables.py](tables.py) | **C4.1 / C4.3.** the long table → the per-architecture display tables, the references from `../C2_Exact_scheme_table`, and the eight csvs the readings rest on | `results/table_cells.csv`, `results/table_<D>x<W>.csv`, `results/table_<D>x<W>_by_direction.csv`, `results/pending_cells.csv`, `results/reading_*.csv` |
...
cd C3_Step_size_and_stage_grid
...
[`../../Block_A_technique_works/A3a_General_leg_network`](../../Block_A_technique_works/A3a_General_leg_network/README_residual.md)'s residual
...
(`../C1_Fine_reference`), a factor of under three. Nothing measured in that stratum
...
field twin, and the lowered floors. `../../Block_A_technique_works/A3a_General_leg_network` was not edited; the
...
parametrisation — wave 1 of `../../Block_A_technique_works/A3a_General_leg_network` started tens of
...
exact scheme of [`../C2_Exact_scheme_table`](../C2_Exact_scheme_table) and the
...
([`../C1_Fine_reference`](../C1_Fine_reference) C1.4) and far lower over a short step,
