...
Three ceiling columns, and the difference between them matters:
  ceiling_leg_um   the published whole-leg value at q = 8, from
                   ../../Block_0_first_pass/S1_Simple_first_pass/results/scheme_error_vs_q.csv. Measured
...
SCHEME = os.path.join(os.path.dirname(os.path.dirname(HERE)),
                    "Block_0_first_pass", "S1_Simple_first_pass", "results")
