...
`../../Block_0_first_pass/S1_Simple_first_pass/results/scheme_error_vs_q.csv` already records the exact
...
`../../Block_0_first_pass/S1_Simple_first_pass/exact_scheme.py`, so this ceiling and that one come from
