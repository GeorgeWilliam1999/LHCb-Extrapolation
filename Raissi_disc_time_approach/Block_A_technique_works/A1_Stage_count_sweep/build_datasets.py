...
Two checks are asserted rather than merely reported:
  ...
  2. at q = 8 the dataset must reproduce the verified baseline
     S2b_One_step_network_v2/results/frozen_leg_data.npz **bitwise on every array
...
BASELINE_NPZ = os.path.join(HERE, "..", "..", "Block_0_first_pass", "S2b_One_step_network_v2", "results",
                            "frozen_leg_data.npz")
...
def bitwise_same(new_npz, baseline_npz):
    ...
    the baseline was written by the older `S2b_One_step_network_v2/prepare_data.py`,
