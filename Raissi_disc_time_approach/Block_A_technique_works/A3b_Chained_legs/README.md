# A3b_Chained_legs — the network walked along real particle paths  (A3b)
...
All 26 networks from `../A3a_General_leg_network` (cluster 5781158, all converged)
...
The 13 runs of cluster 5781443 (`../A3a_General_leg_network`, 12 of 13 converged;
