...
loaded and from which dataset:
    ...
    ../A3a_General_leg_network/results/residual_w*_s*.json  +  .pt
    ../A3a_General_leg_network/results/general_legs_residual.npz
...
TRAINED = os.environ.get("A3_TRAINED") or os.path.join(
    os.path.dirname(HERE), "A3a_General_leg_network", "results")
GENERAL = os.path.join(os.path.dirname(HERE), "A3a_General_leg_network")
