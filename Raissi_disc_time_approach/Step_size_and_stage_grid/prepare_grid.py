...
`../Magnet_tracks_dataset/results/magnet_tracks_v3.npz` is read and written
...
(`../General_leg_network/README_residual.md`) established that on three fixed
...
SOURCE = os.path.join(HERE, "..", "Magnet_tracks_dataset", "results",
