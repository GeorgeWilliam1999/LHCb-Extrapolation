# S2b_One_step_network_v2 — the step-2 experiment on official-sample data

Identical experiment to `../S2_One_step_network/` (the paper's one-step q=8 network on the
...
| [training.py](training.py) | v1 script with OUTER=150 (straight to stall); model/field imported from `../S2_One_step_network` |
